...
const OnProgressList = ({ tasks, ids, idProject, projects, setProjects, totalTasks, setTotalTasks, change, setChange }: any) => {
    ...
    return (
        <div className='bg-[#F5F5F5] rounded-2xl w-5/6 pb-3'>
            ...
            <div className='flex flex-col items-center gap-3 mt-5'>
                ...
                (
                    <CardOnProgressList key={ix} id={ids[ix]} idProject={idProject} projects={projects} setProjects={setProjects} task={task} totalTasks={totalTasks} change={change} setChange={setChange} setTotalTasks={setTotalTasks} />
                )
                )}
            </div>
        </div >
