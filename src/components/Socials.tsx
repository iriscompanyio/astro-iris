...
const Socials = () => {
  ...
  return (
    <div id="redes" className="flex flex-col items-center dark:bg-dark w-full p-[5%] space-y-[5%]">
      <div className="flex flex-col items-center">
        <p className="font-poppins font-semibold text-[20px] md:text-[40px] text-[#2E526B] dark:text-white">
          ...
          {socials.map((social, index) => (
            <div className="flex flex-col" key={index}>
              <button
                ...
                className={`text-black dark:text-stone-100 font-poppins text-xs md:text-[21px] border-2 border-[#688297] rounded-full md:rounded-2xl px-5 py-2 md:px-10 md:py-4 transition duration-500 hover:bg-[#4646FA] hover:border-[#4646FA] hover:text-white uppercase ${selected === index &&
      ...
      <div className="flex overflow-hidden w-full items-center pb-[8%]">
        {socials.map((social, index) => (
          <div
          ...
          >
            ...
            <div className="w-[90%] md:w-auto flex flex-col justify-center space-y-8 md:space-y-12">
              <p className="font-poppins font-extrabold text-[16px] md:text-[21px] lg:text-[35px] text-center text-black dark:text-stone-100">
                {social.message}
              </p>
              <a
                href={social.href}
              ...
              >
                ...
                <p className="font-poppins font-extrabold text-[16px] md:text-[21px] text-black dark:text-stone-100">
                  {social.user}
                </p>
              </a>
            </div>
